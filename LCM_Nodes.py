...
class LCMGenerate:
    ...
    def mainfunc(self, text: str,steps: int,width:int,height:int,gfc:float,seed: int,image,mask,original_image,outpaint_size,outpaint_direction,mode,pipe,batch):
        '''
        # Save Path:
        save_path = "./lcm_images"
...
class LCMGenerate_img2img:
    ...
    def mainfunc(self, text: str,steps: int,width:int,height:int,gfc:float,seed: int,image,outpaint_size,outpaint_direction,mode,pipe,batch,strength):
        '''
        # Save Path:
        save_path = "./lcm_images"
