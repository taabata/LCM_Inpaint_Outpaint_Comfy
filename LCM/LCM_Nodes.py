...
class LCMGenerate:
    ...
    def mainfunc(self, text: str,steps: int,width:int,height:int,gfc:float,device:str,seed: int,image,mask,original_image,outpaint_size,outpaint_direction,mode):
