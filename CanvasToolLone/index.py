...
def grabwfsmodels():
    models = [i for i in os.listdir('../../../models/diffusers') if os.path.isdir(f"../../../models/diffusers/{i}")]
    wfs = os.listdir('./workflows')
...
def generate():
    ...
    def queue_prompt(prompt_workflow):
        ...
        rq.urlopen(req)
    prompt_workflow = json.load(open(f'./workflows/{wf}'))
